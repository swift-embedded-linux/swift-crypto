...
#define BCM_mldsa65_prehash_finalize BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, BCM_mldsa65_prehash_finalize)
#define BCM_mldsa65_prehash_init BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, BCM_mldsa65_prehash_init)
#define BCM_mldsa65_prehash_update BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, BCM_mldsa65_prehash_update)
...
#define BCM_mldsa65_sign_message_representative BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, BCM_mldsa65_sign_message_representative)
...
#define BCM_mldsa87_prehash_finalize BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, BCM_mldsa87_prehash_finalize)
#define BCM_mldsa87_prehash_init BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, BCM_mldsa87_prehash_init)
#define BCM_mldsa87_prehash_update BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, BCM_mldsa87_prehash_update)
...
#define BCM_mldsa87_sign_message_representative BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, BCM_mldsa87_sign_message_representative)
...
#define bn_sqr_add_words BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, bn_sqr_add_words)
...
#define CBB_discard BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, CBB_discard)
...
#define ECDSA_sign_p1363 BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, ECDSA_sign_p1363)
...
#define ECDSA_size_p1363 BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, ECDSA_size_p1363)
...
#define ECDSA_verify_p1363 BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, ECDSA_verify_p1363)
...
#define MLDSA65_prehash_finalize BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA65_prehash_finalize)
#define MLDSA65_prehash_init BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA65_prehash_init)
#define MLDSA65_prehash_update BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA65_prehash_update)
...
#define MLDSA65_sign_message_representative BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA65_sign_message_representative)
#define MLDSA65_verify BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA65_verify)
#define MLDSA87_generate_key BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA87_generate_key)
#define MLDSA87_marshal_public_key BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA87_marshal_public_key)
#define MLDSA87_parse_public_key BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA87_parse_public_key)
#define MLDSA87_prehash_finalize BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA87_prehash_finalize)
#define MLDSA87_prehash_init BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA87_prehash_init)
#define MLDSA87_prehash_update BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA87_prehash_update)
#define MLDSA87_private_key_from_seed BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA87_private_key_from_seed)
#define MLDSA87_public_from_private BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA87_public_from_private)
#define MLDSA87_sign BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA87_sign)
#define MLDSA87_sign_message_representative BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA87_sign_message_representative)
#define MLDSA87_verify BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, MLDSA87_verify)
...
#define OPENSSL_adjust_ia32cap BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, OPENSSL_adjust_ia32cap)
...
#define v3_certificate_issuer BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, v3_certificate_issuer)
...
#define v3_issuer_alt_name BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, v3_issuer_alt_name)
...
#define v3_netscape_base_url BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, v3_netscape_base_url)
#define v3_netscape_ca_policy_url BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, v3_netscape_ca_policy_url)
#define v3_netscape_ca_revocation_url BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, v3_netscape_ca_revocation_url)
#define v3_netscape_comment BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, v3_netscape_comment)
#define v3_netscape_renewal_url BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, v3_netscape_renewal_url)
#define v3_netscape_revocation_url BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, v3_netscape_revocation_url)
#define v3_netscape_ssl_server_name BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, v3_netscape_ssl_server_name)
...
#define v3_subject_alt_name BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, v3_subject_alt_name)
...
#define XWING_decap BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, XWING_decap)
#define XWING_encap BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, XWING_encap)
#define XWING_encap_external_entropy BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, XWING_encap_external_entropy)
#define XWING_generate_key BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, XWING_generate_key)
#define XWING_marshal_private_key BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, XWING_marshal_private_key)
#define XWING_parse_private_key BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, XWING_parse_private_key)
#define XWING_public_from_private BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, XWING_public_from_private)
#define sk_TRUST_TOKEN_PRETOKEN_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_TRUST_TOKEN_PRETOKEN_call_free_func)
...
#define sk_TRUST_TOKEN_PRETOKEN_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_TRUST_TOKEN_PRETOKEN_delete_if)
#define sk_X509_LOOKUP_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_LOOKUP_call_free_func)
...
#define sk_X509_LOOKUP_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_LOOKUP_delete_if)
...
#define sk_BY_DIR_HASH_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_BY_DIR_HASH_delete_if)
...
#define sk_BY_DIR_ENTRY_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_BY_DIR_ENTRY_delete_if)
...
#define sk_X509V3_EXT_METHOD_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509V3_EXT_METHOD_delete_if)
...
#define sk_X509_POLICY_NODE_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_POLICY_NODE_delete_if)
...
#define sk_X509_POLICY_LEVEL_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_POLICY_LEVEL_delete_if)
...
#define sk_STACK_OF_X509_NAME_ENTRY_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_STACK_OF_X509_NAME_ENTRY_delete_if)
#define sk_X509_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_call_free_func)
...
#define sk_X509_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_delete_if)
#define sk_GENERAL_NAME_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_GENERAL_NAME_call_free_func)
...
#define sk_GENERAL_NAME_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_GENERAL_NAME_delete_if)
#define sk_X509_CRL_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_CRL_call_free_func)
...
#define sk_X509_CRL_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_CRL_delete_if)
...
#define sk_X509_REVOKED_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_REVOKED_delete_if)
#define sk_X509_NAME_ENTRY_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_NAME_ENTRY_call_free_func)
...
#define sk_X509_NAME_ENTRY_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_NAME_ENTRY_delete_if)
...
#define sk_X509_NAME_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_NAME_delete_if)
#define sk_X509_EXTENSION_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_EXTENSION_call_free_func)
...
#define sk_X509_EXTENSION_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_EXTENSION_delete_if)
...
#define sk_GENERAL_SUBTREE_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_GENERAL_SUBTREE_delete_if)
...
#define sk_ACCESS_DESCRIPTION_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ACCESS_DESCRIPTION_delete_if)
#define sk_DIST_POINT_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_DIST_POINT_call_free_func)
...
#define sk_DIST_POINT_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_DIST_POINT_delete_if)
...
#define sk_POLICYQUALINFO_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_POLICYQUALINFO_delete_if)
#define sk_POLICYINFO_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_POLICYINFO_call_free_func)
...
#define sk_POLICYINFO_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_POLICYINFO_delete_if)
#define sk_POLICY_MAPPING_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_POLICY_MAPPING_call_free_func)
...
#define sk_POLICY_MAPPING_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_POLICY_MAPPING_delete_if)
...
#define sk_X509_ALGOR_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_ALGOR_delete_if)
...
#define sk_X509_ATTRIBUTE_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_ATTRIBUTE_delete_if)
#define sk_X509_OBJECT_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_OBJECT_call_free_func)
#define sk_X509_OBJECT_call_copy_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_OBJECT_call_copy_func)
#define sk_X509_OBJECT_call_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_OBJECT_call_cmp_func)
#define sk_X509_OBJECT_new BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_OBJECT_new)
...
#define sk_X509_OBJECT_deep_copy BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_OBJECT_deep_copy)
#define sk_X509_OBJECT_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_OBJECT_delete_if)
#define sk_X509_INFO_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_INFO_call_free_func)
...
#define sk_X509_INFO_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_X509_INFO_delete_if)
#define sk_CRYPTO_BUFFER_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CRYPTO_BUFFER_call_free_func)
...
#define sk_CRYPTO_BUFFER_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CRYPTO_BUFFER_delete_if)
...
#define sk_ASN1_INTEGER_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_INTEGER_delete_if)
#define sk_ASN1_OBJECT_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_OBJECT_call_free_func)
#define sk_ASN1_OBJECT_call_copy_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_OBJECT_call_copy_func)
#define sk_ASN1_OBJECT_call_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_OBJECT_call_cmp_func)
...
#define sk_ASN1_OBJECT_set_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_OBJECT_set_cmp_func)
#define sk_ASN1_OBJECT_deep_copy BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_OBJECT_deep_copy)
#define sk_ASN1_OBJECT_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_OBJECT_delete_if)
...
#define sk_ASN1_TYPE_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_TYPE_delete_if)
...
#define sk_BIO_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_BIO_delete_if)
#define sk_CONF_VALUE_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CONF_VALUE_call_free_func)
...
#define sk_CONF_VALUE_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_CONF_VALUE_delete_if)
...
#define sk_void_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_void_delete_if)
#define sk_OPENSSL_STRING_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_OPENSSL_STRING_call_free_func)
#define sk_OPENSSL_STRING_call_copy_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_OPENSSL_STRING_call_copy_func)
#define sk_OPENSSL_STRING_call_cmp_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_OPENSSL_STRING_call_cmp_func)
#define sk_OPENSSL_STRING_new BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_OPENSSL_STRING_new)
...
#define sk_OPENSSL_STRING_deep_copy BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_OPENSSL_STRING_deep_copy)
#define sk_OPENSSL_STRING_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_OPENSSL_STRING_delete_if)
#define sk_TRUST_TOKEN_call_free_func BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_TRUST_TOKEN_call_free_func)
...
#define sk_TRUST_TOKEN_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_TRUST_TOKEN_delete_if)
...
#define sk_ASN1_VALUE_delete_if BORINGSSL_ADD_PREFIX(BORINGSSL_PREFIX, sk_ASN1_VALUE_delete_if)
